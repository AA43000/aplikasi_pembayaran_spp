...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Apr 2020 pada 05.26
...
(1, 1, '12345678', '2020-04-07', 'april', '2020', 1, 750000),
(2, 1, '87654321', '2020-04-14', 'november', '2020', 1, 1000000);
...
INSERT INTO `pesan` (`id_pesan`, `nama`, `nisn`, `pesan`) VALUES
(1, 'Ahmad Zaeni Mubarok', '12345678', 'sukses');
...
(1, 'admin', 'admin123', 'Ahmad', 'admin'),
(2, 'petugas', 'petugas', 'Mubarok', 'petugas');
...
('12345678', '0992', 'Ahmad Zaeni Mubarok', 1, 'Dukuh Plantungan', '081328331831', 1),
('87654321', '1000', 'Zaeni Ahmad', 1, 'sumberejo', '083838534404', 1);
